...
//console.log("start usestream");
//const assets = useStreamQuery(Main.CitizenInvitation); 
//console.log("stop usestream");
...
console.log ("obj" + obj);
const obj2 = JSON.parse(obj); 
console.log ("obj role-type" + JSON.stringify(obj2.result[0].payload.roletype));
 // console.log ("obj role-type" + JSON.stringify(obj2.contracts[0]))
